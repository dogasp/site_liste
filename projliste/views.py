...
("Axel.Le", "sponso/axel le.png", "Besoin de vous essuyer après des ébats sous la couette ? Notre partenaire saura vous aider ...\nRendez-vous lors de nos évenements pour reçevoir des essuie-fraise"), ("Credit Mutuel", "sponso/cm.png", "Envie de changer de banque, c'est le bon moment avec 50€ offerts à la création du compte")]
...
("Journée de campagne", "Mercredi 9 mars 2022", "Vous l'attendiez tous. La journée la plus attendue de l'année. Au programme ? Dès 6h, un petit déjeuner vous attendra pour vous remettre de la veille. Tout au long de la journée, diverses activités dont un certain mariage... vous feront patienter jusqu'à une nain'croyable soirée !", "C'est la journée la plus importante de l'année, il faut garder un peu de surprise voyons...")]
